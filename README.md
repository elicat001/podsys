...
| ④ 图生视频 | 商品 TikTok 带货视频(智谱 CogVideoX-3 真视频,可插拔;无 key 兜底 GIF):**双分镜 15s** · **智能方案向导**(看图出分镜脚本)· **多语言旁白+字幕**(edge-tts)· 场景母帧一致性 · 案例库。详见 [`docs/plans/2026-06-23-video-pipeline.md`](docs/plans/2026-06-23-video-pipeline.md) | 🟢 已实现(动态表现力优化中) |
