...
def smart_describe(image: Image.Image, video_type: str = "开箱分享", seconds: int = 10,
    ...
    prompt = (
        ...
        "④ 动作要贴合 AI 视频的能力边界(这是所有商品的通用约束,不只针对某一类):高风险物理状态变化"
        "(开盖/拧盖、拆封开箱、组装拆卸、穿脱、折叠、倾倒液体)可简化或弱化,但低风险的连续动作要【大胆做、有明确进展、有真实运动幅度】、"
        "贴合商品真实用法、让画面有动感而非几乎不动;让手与物体接触、动作连续且符合重力,绝不出现部件无人触碰却自行开合、或物体凭空出现/消失/移动;\n"
