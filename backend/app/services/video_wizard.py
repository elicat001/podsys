...
def generate_proposals(name: str, audience: str, selling_points: str, *, seconds: int = 10,
    ...
    if two_shot:
        ...
        shot_fields = (
            ...
            '"shot1":"分镜①脚本(约5s,【0-x秒】轴):起因动作,且【结尾停在一个未完成的动作上】(如 笑着起身、手伸向钥匙),给②留接口",'
            '"scene2":"分镜②母帧:【承接①未完成动作的那一刻】的状态(如 钥匙已在手、门正被推开的瞬间),不是全新站姿",'
            '"shot2":"分镜②脚本(约5s):从①的延续点接着演(推门、迈步往外),情绪延续,结尾再留一个未完成动作给③",'
            '"scene3":"分镜③母帧:【承接②的那一刻】(如 刚迈出家门、一只脚已在街上),不是全新站姿",'
            '"shot3":"分镜③脚本(约5s):承接②继续(已走在街上、边走边自然张望),把情绪/目标收住",'
    ...
    prompt = (
        ...
        "【表情自然、别营业笑】人物多数时候不看镜头、专注做自己的事,表情随情绪自然流露,不要全程对镜头僵硬微笑;"
