...
def generate_proposals(name: str, audience: str, selling_points: str, *, seconds: int = 10,
    ...
    prompt = (
        ...
        "【人物行为(最重要)】:让人物像在过自己的真实生活、专注做一件具体的事(准备出门/喝咖啡/出街…),"
        "商品是顺带穿着/使用的道具,不是被举着对镜头展示的对象。每拍写具体、低风险的生活动作"
        "(整理衣领/拉衣角/转身/甩头发/端起杯子/低头看手机/推门/走动/把包甩上肩/回头 等按情境选 1~2 个);"
        "破除「太礼貌」:别全程看镜头傻笑、别举着商品对镜头展示——人物注意力在自己做的事上、视线自然时离开镜头、像没意识到在拍。"
        "镜头次之:基础手持随手拍感即可,不必堆运镜。\n"
